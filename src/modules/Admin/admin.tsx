      ...
      <aside className={`${collapsed ? "w-20" : "w-64"} bg-gray-900 text-white flex flex-col justify-between transition-all duration-300`}>
        <div>
          ...
          <nav className="flex-1 px-2 py-6 space-y-2">
            <a href="/admin" className={`flex items-center gap-3 py-2 px-3 rounded ${!collapsed ? "bg-gray-800 font-semibold" : "justify-center"}`}>{collapsed ? <span className="text-lg">🏠</span> : "Dashboard"}</a>
            <a href="/admin/users" className={`flex items-center gap-3 py-2 px-3 rounded hover:bg-gray-800 ${collapsed ? "justify-center" : ""}`}>{collapsed ? <span className="text-lg">👤</span> : "Users"}</a>
            <a href="/admin/episodes" className={`flex items-center gap-3 py-2 px-3 rounded hover:bg-gray-800 ${collapsed ? "justify-center" : ""}`}>{collapsed ? <span className="text-lg">🎬</span> : "Quản lý tập phim"}</a>
            <a href="/admin/blogs" className={`flex items-center gap-3 py-2 px-3 rounded hover:bg-gray-800 ${collapsed ? "justify-center" : ""}`}>{collapsed ? <span className="text-lg">📝</span> : "Quản lý blog"}</a>
          </nav>
        </div>
        <button
